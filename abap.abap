...
CLASS priority IMPLEMENTATION.
  ...
  METHOD get_list_from_bc.
    ...
    result = 
    me->build_maintain_output_list( EXPORTING im_quermesse = lt_data
  ...
  METHOD build_maintain_output_list.
    ...
    DATA:
      ls_report_empty TYPE priority=>ty_output,
    ...
    IF lines( im_quermesse ) > 0.
      ...
      LOOP AT im_quermesse INTO DATA(ls_quermesse).
        ...
        APPEND VALUE #( priority        = COND #( WHEN ls_ordenacao IS NOT INITIAL
                        ...
                        bc              = ls_quermesse-bc
                        bc_name         = me->get_bc_name( ls_quermesse-bc )
                        functional      = ls_quermesse-ernam
                        functional_name = me->get_bc_name( ls_quermesse-ernam )
...
*    ENDLOOP.
  ...
  METHOD get_report_list.
    ...
    me->build_maintain_output_list( EXPORTING im_quermesse = lt_quermesse
                                     im_priority  = lt_priority
  ...
  METHOD create_controls.
    ...
    CASE me->gv_operation_type.
      ...
      WHEN me->gc_option_type-report.
        ...
        cl_demo_output=>begin_section( title = 'Lista de atendimento por ordem de prioridades' ).
